...
import com.rssawhney.delhicleanair.adapter.TopicAdapter;
import com.rssawhney.delhicleanair.application.CarbonForumApplication;
import com.rssawhney.delhicleanair.config.APIAddress;
import com.rssawhney.delhicleanair.service.PushService;
import com.rssawhney.delhicleanair.util.HttpUtil;
import com.rssawhney.delhicleanair.util.JSONUtil;
    ...
    private void refreshDrawer(Bundle savedInstanceState){
        try{
            ...
            if(!CarbonForumApplication.isLoggedIn()){ //未登录
                ...
                final IProfile profile = new ProfileDrawerItem()
                        .withName(CarbonForumApplication.userInfo.getString("UserName", "rssawhney"))
                        .withEmail(CarbonForumApplication.userInfo.getString("UserMail", CarbonForumApplication.userInfo.getString("UserName", "rssawhney")))
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem != null) {
                            ...
                            if (drawerItem.getIdentifier() == 2) {
                                ...
                                intent = new Intent(IndexActivity.this, AboutActivity.class);
                            }
                            if (intent != null) {
